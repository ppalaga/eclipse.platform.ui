...
public class PathComparatorTest {
	...
	public void lessThanRelativeDashSlash() {
		assertLessThan(Path.forWindows("f1/f1"), Path.forPosix("f1-f2"));
	}

	@Test
	public void lessThanRelativeDepth1() {
		assertLessThan(Path.forWindows("f1"), Path.forPosix("f2"));
	}
	...
	public void deviceALessThanDeviceB() {
		assertLessThan(Path.forWindows("a:/f1/f2"), Path.forPosix("b:/f1/f2"));
	}

	@Test
	public void relativeLessThanAbsolute() {
		assertLessThan(Path.forWindows("f1/f2"), Path.forPosix("/f1/f2"));
	}
	...
	public void uncLessThanDevice() {
		assertLessThan(Path.forWindows("//f1/f2"), Path.forPosix("a:/f1/f2"));
	}
